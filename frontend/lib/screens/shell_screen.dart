          ...
          Expanded(
            child: NavigationRail(
              ...
              destinations: const [
                ...
                NavigationRailDestination(icon: Icon(Icons.bar_chart_rounded), label: Text('Statistics')),
                NavigationRailDestination(icon: Icon(Icons.compare_arrows_rounded), label: Text('Comparison')),
                NavigationRailDestination(icon: Icon(Icons.verified_user_rounded), label: Text('Accountability')),
